...
namespace FileSearcherDemo.Controllers
{
    ...
    public static class RenameMenuController
    {
        ...
        public static async Task SetRenameFileBindingModelIsPressedAsync(RenameFileBindingModel renameFileBindingModel)
        {
            await Task.Run(() => SetRenameFileBindingModelIsPressed(renameFileBindingModel));
        }
        public static async Task CheckIfUserPressesEnterAsync(string textBoxText, RenameFile RenameFileForm, KeyPressEventArgs e, RenameFileBindingModel bindingModel)
        {
        ...
        public static async Task CheckIfTextBoxIsEmptyAsync(string textBoxText, RenameFile RenameFileForm, RenameFileBindingModel bindingModel)
        {
