...
namespace FileSearcherDemo.Views
{
    ...
    public partial class CreateFile : Form
    {
        ...
        {
            await CreateMenuController.SetCreateFileBindingModelTextPressedAsync(bindingModel);
            await CreateMenuController.CheckIfTextBoxIsEmptyAsync(textBox1.Text, this, bindingModel);
        ...
        {
            await CreateMenuController.SetCreateFileBindingModelWordPressedAsync(bindingModel);
            await CreateMenuController.CheckIfTextBoxIsEmptyAsync(textBox1.Text, this, bindingModel);
            //Resets textbox for next use
            textBox1.Text = String.Empty;
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            await CreateMenuController.SetCreateFileBindingModelPowerPointPressedAsync(bindingModel);
            await CreateMenuController.CheckIfTextBoxIsEmptyAsync(textBox1.Text, this, bindingModel);
            //Resets textbox for next use
            textBox1.Text = String.Empty;
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            ...
            await CreateMenuController.SetCreateFileBindingModelExcelPressedAsync(bindingModel);
            await CreateMenuController.CheckIfTextBoxIsEmptyAsync(textBox1.Text, this, bindingModel);
            //Resets textbox for next use
            textBox1.Text = String.Empty;
        ...
        {
            await CreateMenuController.SetCreateFileBindingModelRarPressedAsync(bindingModel);
            await CreateMenuController.CheckIfTextBoxIsEmptyAsync(textBox1.Text, this, bindingModel);
            //Resets textbox for next use
            textBox1.Text = String.Empty;
        ...
        {
            await CreateMenuController.SetCreateFileBindingModelIsPressedAsync(bindingModel);
            //Resets textbox for next use
            textBox1.Text = String.Empty;
            this.Close();
        }
        ...
        private async void CreateFile_KeyPress(object sender, KeyPressEventArgs keyEvent)
        {
            await CreateMenuController.CheckIfUserPressesEnterAsync(textBox1.Text, this, keyEvent, bindingModel);
        }
