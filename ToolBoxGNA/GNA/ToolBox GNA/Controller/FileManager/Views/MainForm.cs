...
namespace FileSearcherDemo
{
    ...
    public partial class MainForm : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            await MainMenuController.PopulateSearchInformation(textBox1, textBox2, richTextBox1, richTextBox2);
        }
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            ...
            await MainMenuController.PopulateCopyInformation(textBox1, textBox2, richTextBox1, richTextBox2);
        }
        ...
        private async void button5_Click(object sender, EventArgs e)
        {
            ...
            await MainMenuController.PopulateMoveInformation(textBox1, textBox2, richTextBox1, richTextBox2);
        }
        ...
        private async void button6_Click(object sender, EventArgs e)
        {
            ...
            await MainMenuController.PopulateDeleteInformation(textBox1, richTextBox1, richTextBox2);
        }
        ...
        private async void button7_Click(object sender, EventArgs e)
        {
            ...
            await MainMenuController.PopulateRenameInformation(textBox1, richTextBox1, richTextBox2);
        }
        ...
        private async void button10_Click(object sender, EventArgs e)
        {
            ...
            await MainMenuController.PopulateCreateInformation(textBox2, richTextBox1, richTextBox2);
        }
