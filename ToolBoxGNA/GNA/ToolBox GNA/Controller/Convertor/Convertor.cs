...
namespace ToolBox_GNA.Controller.Convertor
{
    public static class Convertor
    {
        ...
        public static async Task DocumentToPDFConvertAsync(string inputPath, string outPath)
        {
            DocumetConvertorService document = new DocumetConvertorService();
            await Task.Run(() => document.WordToPDFConv(inputPath, outPath));
        }
        public static async Task ImageToPNGConvertAsync(string inputPath, string outPath)
        {
