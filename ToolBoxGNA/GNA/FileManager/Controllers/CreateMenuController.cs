...
namespace FileSearcherDemo.Controllers
{
    ...
    public static class CreateMenuController
    {
        ...
        public static async void SetCreateFileBindingModelIsPressedAsync(CreateFileBindingModel createFileBindingModel)
        {
        ...
        //Method is called in CreateFile Form to get the input of user 
        public static async void SetCreateFileBindingModelTextPressedAsync(CreateFileBindingModel createFileBindingModel)
        {
            //uses CreateFileBindingModel to set its properties.
        ...
        //Method is called in CreateFile Form to get the input of user 
        public static async void SetCreateFileBindingModelWordPressedAsync(CreateFileBindingModel createFileBindingModel)
        {
            //uses CreateFileBindingModel to set its properties.
        ...
        //Method is called in CreateFile Form to get the input of user 
        public static async void SetCreateFileBindingModelPowerPointPressedAsync(CreateFileBindingModel createFileBindingModel)
        {
            //uses CreateFileBindingModel to set its properties.
        ...
        //Method is called in CreateFile Form to get the input of user 
        public static async void SetCreateFileBindingModelExcelPressedAsync(CreateFileBindingModel createFileBindingModel)
        {
            //uses CreateFileBindingModel to set its properties.
        ...
        public static async void CheckIfTextBoxIsEmptyAsync(string textBoxText, CreateFile CreateFileForm, CreateFileBindingModel bindingModel)
        {
            //uses string textBoxText to get user input for a name of a file
            //uses CreateFile Form, KeyPressEventArgs to check if user has done everything properly on that form.
            //uses CreateFileBindingModel to set its properties.
