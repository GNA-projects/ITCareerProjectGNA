...
namespace FileSearcherDemo.Controllers
{
    ...
    public static class SearchMenuController
    {
        ...
        public static async void SetSearchFileBindingModelIsPressedAsync(SearchFileBindingModel searchFileBindingModel)
        {
            await Task.Run(() => SetSearchFileBindingModelIsPressed(searchFileBindingModel));
        }
        public static void SetSearchFileBindingModelIsPressedNonAsync(SearchFileBindingModel searchFileBindingModel)
        {
            SetSearchFileBindingModelIsPressed(searchFileBindingModel);
        }
        public static async void CheckIfUserPressesEnterAsync(string textBoxText, SearchFile SearchFileForm, KeyPressEventArgs e, SearchFileBindingModel bindingModel)
        {
        ...
        public static void CheckIfUserPressesEnterNonAsync(string textBoxText, SearchFile SearchFileForm, KeyPressEventArgs e, SearchFileBindingModel bindingModel)
        {
            //uses string textBoxText to get user input for a name of a file
            //uses SearchFile Form, KeyPressEventArgs to check if user has done everything properly on that form.
            //uses SearchFileBindingModel to set its properties.
            ...
            {
                //checks if user has pressed Enter in SearchFile Form
                CheckIfTextBoxIsEmpty(textBoxText, SearchFileForm, bindingModel);
            }

        }
        public static async void CheckIfTextBoxIsEmptyAsync(string textBoxText, SearchFile SearchFileForm, SearchFileBindingModel bindingModel)
        {
            //uses string textBoxText to get user input for a name of a file
        ...
        public static void CheckIfTextBoxIsEmptyNonAsync(string textBoxText, SearchFile SearchFileForm, SearchFileBindingModel bindingModel)
        {
            //uses string textBoxText to get user input for a name of a file
            //uses SearchFile Form to check if user has done everything properly on that form.
            //uses SearchFileBindingModel to set its properties.
